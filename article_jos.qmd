...
This method can be used inR with the function `rjd3filters::fst_filter()`.
...
This paper presents the R package `rjd3filters`, which implements a several methods to build moving average for real-time trend-cycle estimation.
