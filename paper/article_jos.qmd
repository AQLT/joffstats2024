...
Event if some papers model $\xi_t$ and $\varepsilon_t$ separately [see for example @GrayThomson2002], an usual assumption, adopted in this paper, is to is to gather $\xi_t$ and $\varepsilon_t$.
