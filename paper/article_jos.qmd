...
\justifying
*Lecture: on monthly times series, 12-month cycles (associated to the frequency $2\pi/12=\pi/6$) are amplified of 10% ($G_{\boldsymbol\theta}(\pi/6)=1.1$) and associated turning points are detected with a delay of 1 months ($\varphi_{\boldsymbol\theta}(\pi/6)/(\pi/6)\simeq -1$).*\
