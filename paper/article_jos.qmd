...
$$
<!-- The assumption that $\hat\mu(x)$ is unbiased is rarely exactly true, so variance -->
<!-- estimates and confidence intervals are usually computed at small band- -->
<!-- widths where bias is small.  -->
