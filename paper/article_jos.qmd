...
To avoid unrealistic estimates of $|\delta/\sigma|=2/(|R|\sqrt{\pi})$ in real-time, with $R$ the I-C ratio defined in @sec-lppasymf, the value of $|R|$ is truncated to a maximum of 12 (the higher value used in X-11 being 4.5).
