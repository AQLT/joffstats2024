...
A similar approach is used in the X-13ARIMA seasonal adjustment method: the series is extend by one year (by default) with an ARIMA model to minimise the revisions associated to asymmetric filters
