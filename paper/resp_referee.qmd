...
*The modelled of the input time series is now describe more precisely in section 2 (previous section 1).* 
*$TC_t$ is here considered as deterministic*
...
*More explanation with the reference in parentheses*
...
*A lecture note is added in the tables and more explanations are added to the text*
