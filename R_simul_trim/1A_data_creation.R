...
series = list(
  highvariability1 = simulated_tci(time,sigma_nu = 0.08,sigma_e = 1.80,lambda = 72/4,rho = 0.2),
  highvariability2 = simulated_tci(time,sigma_nu = 0.08,sigma_e = 1.80,lambda = 72/4,rho = 0.5),
  highvariability3 = simulated_tci(time,sigma_nu = 0.08,sigma_e = 1.80,lambda = 72/4,rho = 0.6),
...
do.call(rbind, lapply(series, function(x){
  x <- x[, "tc"]
