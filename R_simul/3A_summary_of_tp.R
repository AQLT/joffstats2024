...
saveRDS(all_t, "results_simul/compile_tp/troughs_lp_nn.RDS")
saveRDS(all_p, "results_simul/compile_tp/peaks_lp_nn.RDS")
...
for(dir in c("localic_daf_trunc", "localic_final")){
  ...
  if (length(all_files) > 0){
    ...
    saveRDS(all_t, sprintf("results_simul/compile_tp/troughs_%s_nn.RDS", dir))
    saveRDS(all_p, sprintf("results_simul/compile_tp/peaks_%s_nn.RDS", dir))
  }
}
