...
saveRDS(all_t, "results_simul/compile_tp_norev/troughs_lp.RDS")
saveRDS(all_p, "results_simul/compile_tp_norev/peaks_lp.RDS")


all_files <- list.files("results_simul/lp_nn/",pattern = "_tp",full.names = TRUE)
all_tp_lp <- lapply(seq_along(all_files), function(i){
  print(i)
  f = all_files[i]
  compute_time_lag(data = readRDS(f),
...
saveRDS(all_t, "results_simul/compile_tp_norev/troughs_lp_nn.RDS")
saveRDS(all_p, "results_simul/compile_tp_norev/peaks_lp_nn.RDS")
...
saveRDS(all_t, "results_simul/compile_tp_norev/troughs_arima.RDS")
saveRDS(all_p, "results_simul/compile_tp_norev/peaks_arima.RDS")
...
saveRDS(all_t, "results_simul/compile_tp_norev/troughs_ner_neigh_hend.RDS")
saveRDS(all_p, "results_simul/compile_tp_norev/peaks_ner_neigh_hend.RDS")
