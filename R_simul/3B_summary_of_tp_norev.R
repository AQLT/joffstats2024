...
all_files <- list.files("results_simul/ner_neigh/",pattern = "_tp",full.names = TRUE)
all_tp <- lapply(seq_along(all_files), function(i){
  print(i)
  f = all_files[i]
  compute_time_lag(readRDS(f),                    
...
saveRDS(all_t, "results_simul/compile_tp_norev/troughs_ner_neigh.RDS")
saveRDS(all_p, "results_simul/compile_tp_norev/peaks_ner_neigh.RDS")
